...
public class SoundsManager : MonoBehaviour
{
    ...
    void Start()
    {
        InputManager.onLetterAdded += PlayLetterAddedSounds;
        InputManager.onLetterRemoved += PlayLetterRemovedSounds;
    ...
    private void PlayLetterAddedSounds()
    {
        letterAddedSound.Play();
    }

    private void PlayLetterRemovedSounds()
    {
